...
const API_SERVICES = {
  auth: {
    ...
    changePassword: (matKhauCu, matKhauMoi, xacNhanMatKhau = matKhauMoi) =>
      API_CLIENT.post(API_ENDPOINTS.auth.changePassword, {
        matKhauCu,
        matKhauMoi,
        xacNhanMatKhau,
      }),
    ...
    resetPassword: (email, otp, matKhauMoi) =>
      API_CLIENT.post(API_ENDPOINTS.auth.resetPassword, {
        email,
        otp,
        matKhauMoi,
      }),
  ...
  profile: {
    me: () => API_CLIENT.get(API_ENDPOINTS.profile.me),
    update: (payload) => API_CLIENT.put(API_ENDPOINTS.profile.update, payload),
  },

  nhanVien: {
    list: () => API_CLIENT.get(API_ENDPOINTS.nhanVien.list),
  },

  khachHang: {
    list: () => API_CLIENT.get(API_ENDPOINTS.khachHang.list),
    detail: (id) => API_CLIENT.get(API_ENDPOINTS.khachHang.detail(id)),
    search: (keyword) =>
    ...
    delete: (id, lyDo) =>
      API_CLIENT.delete(
        API_ENDPOINTS.khachHang.delete(id),
        lyDo ? { lyDo } : null,
      ),
    assign: (id, payload) =>
  ...
  chienDich: {
    list: () => API_CLIENT.get(API_ENDPOINTS.chienDich.list),
    detail: (id) => API_CLIENT.get(API_ENDPOINTS.chienDich.detail(id)),
    search: (keyword) =>
      API_CLIENT.get(API_ENDPOINTS.chienDich.search(keyword)),
    create: (payload) =>
    ...
    delete: (id, lyDo) =>
      API_CLIENT.delete(
        API_ENDPOINTS.chienDich.delete(id),
        lyDo ? { lyDo } : null,
      ),
    trash: () => API_CLIENT.get(API_ENDPOINTS.chienDich.trash),
    restore: (id) => API_CLIENT.put(API_ENDPOINTS.chienDich.restore(id)),
    deletePermanently: (id) =>
      API_CLIENT.delete(API_ENDPOINTS.chienDich.deletePermanently(id)),
    statistics: () => API_CLIENT.get(API_ENDPOINTS.chienDich.statistics),
  ...
  nhacNho: {
    ...
    delete: (id) => API_CLIENT.delete(API_ENDPOINTS.nhacNho.delete(id)),
  },

  thongBao: {
    list: () => API_CLIENT.get(API_ENDPOINTS.thongBao.list),
    unreadCount: () => API_CLIENT.get(API_ENDPOINTS.thongBao.unreadCount),
    markRead: (id) => API_CLIENT.patch(API_ENDPOINTS.thongBao.markRead(id), {}),
    markAllRead: () => API_CLIENT.patch(API_ENDPOINTS.thongBao.markAllRead, {}),
  },

  adminUsers: {
    list: () => API_CLIENT.get(API_ENDPOINTS.adminUsers.list),
    create: (payload) =>
      API_CLIENT.post(API_ENDPOINTS.adminUsers.create, payload),
    update: (id, payload) =>
      API_CLIENT.put(API_ENDPOINTS.adminUsers.update(id), payload),
    lock: (id) => API_CLIENT.patch(API_ENDPOINTS.adminUsers.lock(id), {}),
    unlock: (id) => API_CLIENT.patch(API_ENDPOINTS.adminUsers.unlock(id), {}),
    delete: (id) => API_CLIENT.delete(API_ENDPOINTS.adminUsers.delete(id)),
  },

  trungLap: {
    list: () => API_CLIENT.get(API_ENDPOINTS.trungLap.list),
    gop: (id) => API_CLIENT.post(API_ENDPOINTS.trungLap.gop(id)),
  },
